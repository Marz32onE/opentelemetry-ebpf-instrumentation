...
func (r *PeriodicReader) temporality(kind InstrumentKind) sdkmetricdata.Temporality {
	return r.exporter.Temporality(sdkmetric.InstrumentKind(kind))
}

// aggregation returns what Aggregation to use for kind.
func (r *PeriodicReader) aggregation(kind InstrumentKind) sdkmetric.Aggregation { // nolint:revive  // import-shadow for method scoped by type.
	return r.exporter.Aggregation(sdkmetric.InstrumentKind(kind))
}
...
func (r *PeriodicReader) export(ctx context.Context, m *sdkmetricdata.ResourceMetrics) error {
